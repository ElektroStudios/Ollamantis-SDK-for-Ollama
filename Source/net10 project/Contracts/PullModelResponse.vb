...
#Region " PullModelResponse "

    ''' <summary>
    ''' Represents the response containing the result of a <see cref="PullModelRequest"/>.
    ''' </summary>
    ''' 
    ''' <remarks>
    ...
    Public Class PullModelResponse : Inherits ModelTransferResponseBase

#Region " Constructors "

        ''' <summary>
        ''' Prevents a default instance of the <see cref="PullModelResponse"/> class from being created.
        ''' </summary>
        Private Sub New()
        End Sub
        ...
        ''' 
        ''' <param name="status">
        ''' The status of the model being pulled.
        ''' </param>
        ''' 
        ''' <param name="digest">
