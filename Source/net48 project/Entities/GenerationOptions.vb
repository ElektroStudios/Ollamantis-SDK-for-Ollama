...
#Region " Constructors "
        ...
        Public Sub New(Optional contextSize As Integer? = Nothing,
                       Optional repeatLastN As Integer? = Nothing, ' NOSONAR
                       ...
                       Optional topK As Integer? = Nothing, ' NOSONAR
                       Optional topP As Double? = Nothing, ' NOSONAR
                       Optional minP As Double? = Nothing, ' NOSONAR
                       Optional typicalP As Double? = Nothing, ' NOSONAR
                       ...
                       Optional numGPU As Integer? = Nothing, ' NOSONAR
                       Optional mainGPU As Integer? = Nothing, ' NOSONAR
